      ...
      <div className="flex flex-col flex-grow p-4">
        ...
        {isSimples && (
          <div className="flex justify-between items-start mb-4 flex-shrink-0">
            <div className="w-8 h-8 bg-gray-50 rounded border border-gray-100 flex items-center justify-center text-gray-500">
              <Code size={16} />
            </div>
            <span className="text-[10px] font-medium text-blue-600 bg-blue-50 border border-blue-100 px-2 py-1 rounded-full flex items-center gap-1">
        ...
        <div className="flex-grow flex flex-col" title={item.title}>
          ...
          {isAvancado && ['1', '4', '5', '6'].includes(subVariant) && (
            <p className="text-[12px] text-gray-600 line-clamp-3 leading-snug mt-3 flex-shrink-0" title={item.description}>
              {item.description}
            </p>
          )}
          ...
          <div className="mt-auto pt-3 flex justify-between items-end">
            <div className="flex flex-col gap-1.5 items-start">
              ...
              {/* Duration (Simples 2, Completo 2, Avancado 1,2,4,5,6) */}
              ...
              {/* Badges in the footer for Completo 1,3 and Avancado 1,2,4,5,6 */}
              {((isCompleto && ['1', '3'].includes(subVariant)) || (isAvancado && ['1', '2', '4', '5', '6'].includes(subVariant))) && (
                <span className="text-[10px] font-medium text-blue-600 bg-blue-50 border border-blue-100 px-2 py-1 rounded-full flex items-center gap-1 mt-0.5">
                  <BookOpen size={10} /> Treinamentos
                </span>
              )}

              {/* Price Left-aligned for Avancado */}
            ...
            <div className="flex flex-col items-end gap-1.5">
              ...
              {/* Price Right-aligned for Simples/Completo */}
          ...
          <div className="mt-3 pt-3 border-t border-gray-100 flex-shrink-0">
            <div className="flex flex-col gap-1.5">
              ...
              <div className="w-full bg-gray-100 rounded-full h-1">
                <div className="bg-blue-600 h-1 rounded-full" style={{ width: `${item.progress}%` }}></div>
              </div>
              ...
              <div className="w-full bg-gray-100 rounded-full h-1">
                <div className="bg-gray-400 h-1 rounded-full" style={{ width: `${item.grade}%` }}></div>
              </div>
            </div>
          </div>
        )}
  ...
  return (
    <section className="py-8 border-b border-gray-200 last:border-0">
      ...
      <div className="relative group">
        <div 
          onClick={() => scroll('left')}
          className="absolute left-0 top-0 bottom-6 w-16 bg-gradient-to-r from-black/60 to-transparent z-10 flex items-center justify-start opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer rounded-l-xl"
        >
        ...
        <div 
          ...
          className="flex gap-4 overflow-x-auto pb-6 scrollbar-hide snap-x snap-mandatory pr-[20vw] sm:pr-[10vw] items-stretch"
        ...
        <div 
          ...
          className="absolute right-0 top-0 bottom-6 w-16 bg-gradient-to-l from-black/60 to-transparent z-10 flex items-center justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer rounded-r-xl"
        >
