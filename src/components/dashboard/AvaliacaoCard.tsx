          ...
          <div className="flex items-center gap-2">
            ...
            {onRemove && (
              <button
                ...
                className="flex items-center justify-center h-8 w-8 ml-1 rounded-md border border-border bg-white text-muted-foreground hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-colors"
