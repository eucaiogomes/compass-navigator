...
export function riskDistribution(rs: Respondent[]) {
  ...
  return [
    { name: "Baixo", value: low, pct: (low / total) * 100, color: "var(--color-risk-low)" },
    { name: "Moderado", value: mod, pct: (mod / total) * 100, color: "var(--color-risk-moderate)" },
    { name: "Alto", value: high, pct: (high / total) * 100, color: "var(--color-risk-high)" },
  ];
}
